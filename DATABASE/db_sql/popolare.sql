...
insert into creature(nome, comp, tipo, resistenza, forza, velocita, dieta, tmin, tmax, umin, umax) values ('wolf', 1, 'a', 3, 2, 7, 'c', -20, 20, 3, 30);
insert into creature(nome, comp, tipo, resistenza, forza, velocita, dieta, tmin, tmax, umin, umax) values ('cow', 2, 'a', 6, 1, 3, 'e', 30, 40, 20, 40);
insert into creature(nome, comp, tipo, resistenza, forza, velocita, dieta, tmin, tmax, umin, umax) values ('bear', 3, 'a', 9, 7, 2, 'c', -10, 30, 10, 30);
insert into creature(nome, comp, tipo, resistenza, forza, velocita, dieta, tmin, tmax, umin, umax) values ('panther', 4, 'a', 5, 4, 8, 'c', 20, 40, 5, 25);
insert into creature(nome, comp, tipo, resistenza, forza, velocita, dieta, tmin, tmax, umin, umax) values ('rabbit', 5, 'a', 2, 1, 9, 'e', -5, 20, 20, 40);
insert into creature(nome, riprod, tipo, resistenza, tmin, tmax, umin, umax) values ('grass', 90, 'v', 4, 5, 30, 20, 90 );
insert into creature(nome, riprod, tipo, resistenza, tmin, tmax, umin, umax) values ('oak', 30, 'v', 40, 10, 25, 20, 50 );
insert into creature(nome, riprod, tipo, resistenza, tmin, tmax, umin, umax) values ('berry_bush', 10, 'v', 7, 20, 30, 5, 30 );
insert into creature(nome, riprod, tipo, resistenza, tmin, tmax, umin, umax) values ('fir', 50, 'v', 20, -5, 15, 10, 60 );
